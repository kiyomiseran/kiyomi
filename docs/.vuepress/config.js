...
const {navbar} = require("./navbar.js")//导航栏配置
const {friendLinks} = require("./friendLinks")//侧边栏友链配置
const {socials} = require("./socials");//社交链接
const {randomColor} = require("./randomColor");
const {siteInformation} = require("./siteInformation");//友链
const {message} = require("./message");//侧边栏公告
const {donate} = require("./donate");//赞赏页面
module.exports = {
